...
Because the dataset contains all possible combinations of sex and age groups given a specific end week, we decided to drop all observations with "All Sex," which includes both Males and Females in the
